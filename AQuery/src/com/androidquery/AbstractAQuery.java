...
public abstract class AbstractAQuery<T extends AbstractAQuery<T>> implements Constants {
	 ...
	 * @return self
	 */
	public T touched(OnTouchListener listener){
	...
	/**
	 * Register a callback method for when the view is onKey. 
	 *
	 * @param listener The callback method.
	 * @return self
	 */
	public T keyed(OnKeyListener listener){
	...
	public T focusChanged(OnFocusChangeListener listener){
		if(view != null){						
